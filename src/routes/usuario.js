...
//Requerimos la herramienta nodemailer

/*Creamos un transporte donde tendra 
configurado el servidor smtp,
con el correo y contraseña 
*/
const transporter = nodemailer.createTransport({
    ...
    auth: {
        user: "alcidesdaniel.bautista@uttt.edu.mx",
        pass: "ilokie12"
    ...
    try {
        ...
        User.findById(req.params.id, function (err, user) {
             if (err) {
                 ...
                 var js = JSON.stringify(err)
                 var mailOptions = {
                     from: "alcidesdaniel.bautista@uttt.edu.mx",
                     to: "azazelcrow67@gmail.com",
                     subject: "Excepción",
                     text: js
                 };
